...
class PaletteNameAdapter extends BaseAdapter {
    ...
    public PaletteNameAdapter(Context context, int rowLayout, int arrayResourceId) {
        mContext = context;
    ...
    public Object getItem(int i) {
        return mColors.getResourceId(i, PaletteNameAdapter.NO_COLOR);
    }
